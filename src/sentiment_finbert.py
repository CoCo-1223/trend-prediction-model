# src/infer_finbert_news_sentiment.py
# 금융 뉴스 전용 감성분석 파이프라인 
# 모델: snunlp/KR-FinBert-SC
# 데이터: ./data/processed/NewsResult_*_processed.csv
# 결과: ./data/processed/samsung_sentiment_{year}.csv, apple_sentiment_{year}.csv
